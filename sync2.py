...
DEFAULT_LIST = myconfig['icloud']['default_list']
...
# Get all uncompleted Reminders tasks in default list
script = '''
tell application "Reminders"
    set mylist to list "Inbox"
    tell mylist
        make new reminder at end with properties {name:"foobar", due date:date "7/10/2014 3:00 PM"}
    end tell
end tell
'''
